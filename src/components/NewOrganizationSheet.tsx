        ...
        <div className="flex flex-col gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Select label="Tipo do documento" required options={[{ value: 'CNPJ', label: 'CNPJ' }, { value: 'CPF', label: 'CPF' }]} value={form.docType} onChange={value => setField('docType', value ?? '')} />
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Select label="Estado" required options={STATES} placeholder="Selecione" value={form.state} onChange={value => setField('state', value ?? '')} />

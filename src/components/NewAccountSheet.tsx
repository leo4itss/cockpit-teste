      ...
      >
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Select label="Segmento de negócio" options={BUSINESS_SEGMENTS} placeholder="Escolha o segmento" value={form.segmento} onChange={e => set('segmento', e.target.value)} />
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Select label="País / Região" options={[{ value: 'Brasil', label: 'Brasil' }]} value={form.pais} onChange={e => set('pais', e.target.value)} />
            ...
            <div className="grid grid-cols-2 gap-4">
              <Select label="Estado" options={STATES} placeholder="Selecione" value={form.estado} onChange={e => set('estado', e.target.value)} />

...
export const organizations: Organization[] = [
  ...
  // permitida (platform_admin). É o caso "org criada por engano".
  {
    ...
    name: 'Meridiano Log',
    docType: 'CNPJ',
    docNumber: '21.002.443/0001-08',
    domain: 'meridianolog',
    businessSegment: 'Logística',
    activitySector: 'Transporte e Logística',
    razaoSocial: 'Meridiano Logística Ltda',
    qtdContas: 0,
    qtdSolucoes: 0,
    qtdContratos: 0,
    country: 'Brasil',
  ...
  // Cenário: organização ativa cujas contas estão todas inativas → inativação permitida.
  {
    id: 'org-vega',
    name: 'Vega Participações',
    docType: 'CNPJ',
    docNumber: '33.771.905/0001-51',
    domain: 'vegapart',
    businessSegment: 'Holding',
    activitySector: 'Participações Societárias',
    razaoSocial: 'Vega Participações S.A.',
    qtdContas: 2,
    qtdSolucoes: 0,
    qtdContratos: 1,
    country: 'Brasil',
    ...
    city: 'Campinas',
    zipCode: '13010-111',
    address: 'Av. Francisco Glicério, 900',
    complement: '10º andar',
    officialSite: 'www.vegapart.com.br',
    arquitetoPAS: 'Marcelo Gomes',
    status: 'Ativo',

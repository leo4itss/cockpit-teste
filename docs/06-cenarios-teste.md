...
5. **Verificar:** Ações pré-selecionadas incluem: Visualizar, Criar Documento, Editar, Nova Versão, Mover, Cancelar Edição, Baixar Documento, Imprimir, Visualizar Histórico de Versões
...
4. **Verificar:** Ações atualizam automaticamente para: Visualizar, Revisar Documento, Submeter para Aprovação, Solicitar Revisão, Baixar Documento, Imprimir, Visualizar Histórico de Versões
5. **Verificar:** Ações de Editor (Criar Documento, Editar) são desmarcadas
6. Salvar
...
|------------|---------|
| Papel Editor cria ações corretas | Visualizar, Criar Documento, Editar, Nova Versão, etc. |
| Trocar para Revisor atualiza ações | Ações de Editor removidas; ações de Revisor adicionadas |
